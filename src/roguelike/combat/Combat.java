...
public class Combat {
    ...
    public static void meleeCombat(Creature attacker, Creature defender, EventLog eventLog) {
    ...
    public static void magicCombat(Creature attacker, Creature defender, EventLog eventLog,
                                   MagicSpells spell) {

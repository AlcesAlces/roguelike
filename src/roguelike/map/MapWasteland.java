...
public class MapWasteland extends Map{
    
    int density = 100;
    
    public MapWasteland(int pointTempX, int pointTempY, int typeTemp, int idTemp, 
        ...
        this.yMin = yMinTemp;
        */
        this.color = CSIColor.GRAY_ASPARAGUS;
        generateGrassElements();
        overworldChar = '%';
        this.baseInfluence = 35;
    }
    
    public MapWasteland(int xMax, int yMax, int xMin, int yMin, CSIColor color, Point descentPoint, Point ascentPoint) {
    ...
    void generateGrassElements() {
        ...
        MapWasteland map01 = new MapWasteland(mapSizeX, mapSizeY, 0, 0, CSIColor.DARK_GREEN, null, null);

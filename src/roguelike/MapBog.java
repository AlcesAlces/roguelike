...
public class MapBog extends Map{
    
    int density = 100;
    
    public MapBog(int pointTempX, int pointTempY, int typeTemp, int idTemp, 
        ...
        this.yMin = yMinTemp;
        */
        this.color = CSIColor.DARK_GREEN;
        generateGrassElements();
        overworldChar = '#';
        this.baseInfluence = 25;
    }
    
    public MapBog(int xMax, int yMax, int xMin, int yMin, CSIColor color, Point descentPoint, Point ascentPoint) {
    ...
    void generateGrassElements() {
        ...
        MapBog map01 = new MapBog(mapSizeX, mapSizeY, 0, 0, CSIColor.DARK_GREEN, null, null);
